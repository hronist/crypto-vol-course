...
![Улыбка и skew](../assets/vol_smile_skew.svg)
*Срез по страйку: симметричная улыбка (толстые хвосты), put-skew (низкие страйки дороже,
risk-off) и call-skew (высокие страйки дороже, бычий режим). Ось — implied volatility.*
...
![Term structure](../assets/term_structure.svg)
*Срез по сроку: contango (спокойный режим, кривая растёт), backwardation (стресс, кривая
падает) и локальный бугор ATM-IV под известное событие на конкретную дату.*
...
*Следующий урок → [Урок 5. Implied vs realized и volatility risk premium](lesson-05-iv-vs-rv-vrp.md)*
